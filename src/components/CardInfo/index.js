...
const CardInfo = ({name,description,url,count,weight}) => {
  ...
  return (
    ...
    <NavLink style={{color:"primary",textDecoration:"none"}} to="/">Home</NavLink>
      </Button>
      </Box>
      <Paper className={classes.paper}>
        <Grid container  spacing={2}>
          ...
          <Grid item xs={12} sm container>
            ...
            <Grid item>
              <Typography variant="subtitle1">{`pieces left : ${count}`}</Typography>
            </Grid>
          </Grid>
        </Grid>
      </Paper>
